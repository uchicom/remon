...
public class RemonThrough {
              ...
              () -> {
                while (true) {
                  try {
                    ...
                    if (ipMap.isEmpty()
                        || ipMap.containsKey(socket.getInetAddress().getHostAddress())) {
              ...
              () -> {
                while (true) {
                  try {
                    ...
                    if (ipMap.isEmpty()
                        || ipMap.containsValue(socket.getInetAddress().getHostAddress())) {
  ...
  public static void accept(
      ConcurrentHashMap<String, Queue<Socket>> socketQueueMap, Socket socket) {
